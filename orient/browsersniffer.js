...
//
	...
	// get Safari version
	if (is_safari) {
		//alert("is_safari is true");
		if (agt.indexOf('version')!=-1)
			{
			var sfvPos = agt.indexOf('version')+8;
			is_minor = agt.substring(sfvPos,agt.indexOf(' safari'));
			//alert("is_minor: " + is_minor);
			is_major = parseInt(is_minor);
			}
		else
			{
...
// KNOWN BUG: On AOL4, returns false if IE3 is embedded browser
	...
	var is_winvs = ((agt.indexOf("windows nt 6.0")!=-1) || (agt.indexOf("windows vista")!=-1)); // 080314 - tab
	var is_win7 = ((agt.indexOf("windows nt 6.1")!=-1) || (agt.indexOf("windows 7")!=-1)); // 100315 - tab
