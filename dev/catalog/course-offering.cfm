...
<div id="content" >
    ...
    <div id="classofferings">
		<h2><abbr title="Course Reference Number">CRN</abbr>s for this course during the coming term:<br /> <a href="#request.webroot#dsp_class_info.cfm?h=0&tid=#nextterm.Term_ID####Variables.cid#"><strong>#nextterm.TermText#</strong></a></p>
		<cfset count = 0>
		<ul>
		<cfloop query="crns">
			<cfset count = count + 1>
